...
export const getDesignTokens = (mode) => ({
  palette: {
    ...
    success: {
      ...
      500: "#21CC66",
      600: "#1DB45A",
      ...(mode === "dark" && { main: "#1DB45A" }),
      ...(mode === "light" && { main: "#1AA251" }),
      700: "#1AA251",
      800: "#178D46",
      900: "#0F5C2E"
    },
    ...
    components: {
      ...
      MuiTableCell: {
        styleOverrides: {
          ...
          head: { color: theme.palette.text.primary, fontWeight: 700 },
          body: { color: theme.palette.text.secondary }
        }
      },
      ...
      MuiTooltip: { styleOverrides: { tooltip: { padding: "5px 9px" } } },
      MuiSwitch: {
        styleOverrides: {
          root: {
            width: 32,
